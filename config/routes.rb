Rails.application.routes.draw do
  ...
  resources :students, only: :index #  route to vew index page
  ...
  get "students/:id", to: "students#show" # grabs the student from controllers and the show method defined inside
end
